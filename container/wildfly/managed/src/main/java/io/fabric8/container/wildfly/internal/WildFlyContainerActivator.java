...
public final class WildFlyContainerActivator implements ModuleActivator {
    ...
    public void start(ModuleContext context) throws Exception {
        String[] classes = new String[] { WildFlyContainerCreateHandler.class.getName(), ContainerCreateHandler.class.getName() };
        registration = context.registerService(classes, new WildFlyContainerCreateHandler(), null);
    }
