...
public class TomcatManagedContainerBuilder extends ManagedContainerBuilder<TomcatContainerConfiguration, TomcatManagedContainer> {
    ...
    @Override
    protected TomcatContainerConfiguration createConfiguration() {
        return new TomcatContainerConfiguration();
    }
    ...
    @Override
    protected void validateConfiguration(TomcatContainerConfiguration config) {
        ...
        if (config.getJavaVmArguments() == null) {
            setJavaVmArguments(TomcatContainerConfiguration.DEFAULT_JAVAVM_ARGUMENTS);
        }
