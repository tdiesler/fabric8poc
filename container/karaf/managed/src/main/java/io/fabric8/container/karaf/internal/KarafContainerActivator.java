...
public final class KarafContainerActivator implements ModuleActivator {
    ...
    public void start(ModuleContext context) throws Exception {
        String[] classes = new String[] { KarafContainerCreateHandler.class.getName(), ContainerCreateHandler.class.getName() };
        registration = context.registerService(classes, new KarafContainerCreateHandler(), null);
    }
