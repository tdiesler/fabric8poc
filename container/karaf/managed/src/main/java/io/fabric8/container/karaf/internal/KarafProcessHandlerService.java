...
/**
 * The Karaf {@link ProcessHandler} service
 *
...
public final class KarafProcessHandlerService extends AbstractComponent implements ProcessHandler {

    private final KarafProcessHandler delegate = new KarafProcessHandler();
