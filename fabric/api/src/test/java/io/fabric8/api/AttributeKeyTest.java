...
public class AttributeKeyTest {
    ...
    public void testCreateStringAttribute() {
        ...
        Assert.assertEquals("my.key", key.getCanonicalForm());
        ...
        key = AttributeKey.createFrom("my.key,type=string");
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(String.class, key.getType());
        value = key.getFactory().createFrom("my.value");
        Assert.assertEquals("my.value", value);
        ...
        key = AttributeKey.createFrom("my.key");
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(String.class, key.getType());
        value = key.getFactory().createFrom("my.value");
        Assert.assertEquals("my.value", value);
    ...
    public void testCreateShortAttribute() {
        AttributeKey<Short> key = AttributeKey.createFrom("my.key,type=short");
        ...
        Assert.assertEquals("my.key,type=java.lang.Short", key.getCanonicalForm());
        ...
        key = AttributeKey.createFrom("my.key,type=java.lang.Short");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Short.class, key.getType());
        value = key.getFactory().createFrom("1");
    ...
    public void testCreateIntegerAttribute() {
        AttributeKey<Integer> key = AttributeKey.createFrom("my.key,type=integer");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        ...
        Assert.assertEquals("my.key,type=java.lang.Integer", key.getCanonicalForm());
        ...
        key = AttributeKey.createFrom("my.key,type=int");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Integer.class, key.getType());
        value = key.getFactory().createFrom("1");
        ...
        key = AttributeKey.createFrom("my.key,type=java.lang.Integer");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Integer.class, key.getType());
        value = key.getFactory().createFrom("1");
    ...
    public void testCreateLongAttribute() {
        AttributeKey<Long> key = AttributeKey.createFrom("my.key,type=long");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        ...
        Assert.assertEquals("my.key,type=java.lang.Long", key.getCanonicalForm());
        ...
        key = AttributeKey.createFrom("my.key,type=java.lang.Long");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Long.class, key.getType());
        value = key.getFactory().createFrom("1");
    ...
    public void testCreateFloatAttribute() {
        AttributeKey<Float> key = AttributeKey.createFrom("my.key,type=float");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        ...
        Assert.assertEquals("my.key,type=java.lang.Float", key.getCanonicalForm());
        ...
        key = AttributeKey.createFrom("my.key,type=java.lang.Float");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Float.class, key.getType());
        value = key.getFactory().createFrom("1.0");
    ...
    public void testCreateDoubleAttribute() {
        AttributeKey<Double> key = AttributeKey.createFrom("my.key,type=double");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        ...
        Assert.assertEquals("my.key,type=java.lang.Double", key.getCanonicalForm());
        ...
        key = AttributeKey.createFrom("my.key,type=java.lang.Double");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Double.class, key.getType());
        value = key.getFactory().createFrom("1.0");
    ...
    public void testCreateBooleanAttribute() {
        AttributeKey<Boolean> key = AttributeKey.createFrom("my.key,type=boolean");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        ...
        key = AttributeKey.createFrom("my.key,type=java.lang.Boolean");
        Assert.assertNotNull(key);
        Assert.assertEquals("my.key", key.getName());
        Assert.assertEquals(Boolean.class, key.getType());
        value = key.getFactory().createFrom("true");
