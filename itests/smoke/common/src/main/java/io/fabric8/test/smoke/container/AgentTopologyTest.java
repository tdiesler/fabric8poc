...
import io.fabric8.test.smoke.AgentTopologyTestBase;
...
public class AgentTopologyTest extends AgentTopologyTestBase {

    @Deployment
    @StartLevelAware(autostart = true)
    public static Archive<?> deployment() {
        final ArchiveBuilder archive = new ArchiveBuilder("agent-topology-test");
        archive.addClasses(RuntimeType.TOMCAT, AnnotatedContextListener.class);
        archive.addClasses(AgentTopologyTestBase.class, PrePostConditions.class);
        ...
        archive.setManifest(new Asset() {
            ...
            public InputStream openStream() {
                if (ArchiveBuilder.getTargetContainer() == RuntimeType.KARAF) {
                    ...
                    builder.addImportPackages(ObjectNameFactory.class, ManagementUtils.class, AgentTopology.class, ProcessIdentity.class);
                    builder.addImportPackages(MBeanServer.class, CompositeData.class, JMXConnector.class);
                    builder.addImportPackages(JSONObject.class, JolokiaMXBeanProxy.class);
