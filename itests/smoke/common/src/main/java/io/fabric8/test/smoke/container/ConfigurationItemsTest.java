...
public class ConfigurationItemsTest extends ConfigurationItemsTestBase {

    @Deployment
    @StartLevelAware(autostart = true)
    public static Archive<?> deployment() {
        final ArchiveBuilder archive = new ArchiveBuilder("configuration-items-test");
        archive.addClasses(RuntimeType.TOMCAT, AnnotatedContextListener.class);
        archive.addClasses(ConfigurationItemsTestBase.class, PrePostConditions.class);
